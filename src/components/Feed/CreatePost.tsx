    ...
    <Card customStyle='w-full dark:bg-lord-300'>
      <form className='flex flex-col gap-4' encType='multipart/form-data' onSubmit={handleNewPost}>
        <div className='flex md:flex-row flex-col gap-4 items-center justify-center'>
          ...
          <input
            className='bg-application-grey outline-none placeholder:text-sm py-4 px-6 rounded-full flex-1 w-full dark:outline-dark-100 dark:bg-dark-600 dark:placeholder:text-white dark:border-lord-200 dark:text-white'
            type='text'
            name='description'
        ...
        <div className='flex flex-col md:flex-row gap-4 justify-evenly items-center'>
          ...
          {loading ? (
            ...
            <button
              type='submit'
              className='bg-sky-800 hover:bg-sky-600 text-white p-4 py-2 rounded-sm dark:bg-blue-600 dark:hover:bg-blue-700 tracking-widest dark:text-gray-300 font-bold'
            >
              POST
            </button>
          )}
